...
import com.mywatcher.wearappandroid.ui.alarm.AlarmActivity
import com.mywatcher.wearappandroid.ui.end.EndActivity
import kotlinx.coroutines.*
import java.nio.charset.StandardCharsets
import java.util.*

class RunActivity : AppCompatActivity(), CoroutineScope by MainScope(),
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        if (!check_wearable_device) {
            if (!wearableDeviceConnected) {
                val tempAct: Activity = activityContext as RunActivity
            ...
            withContext(Dispatchers.Main) {
                if (getNodesResBool!![0]) {
                    ...
                    if (getNodesResBool[1]) {
                        ...
                        binding.alarmButton.visibility = View.VISIBLE
                    } else {
                        Toast.makeText(
                            activityContext,
